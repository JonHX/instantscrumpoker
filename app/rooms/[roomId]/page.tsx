...
export async function generateStaticParams() {
  ...
  // All other routes will be handled client-side via index.html fallback (SPA pattern)
...
// Other routes will serve index.html and be handled by Next.js client-side router
